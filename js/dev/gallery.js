...
function updateHeroVideoState(swiper, shouldPlay = true) {
  ...
  swiper.slides.forEach((slide2) => {
    slide2.querySelectorAll("video").forEach((video) => {
      if (slide2 === activeSlide && shouldPlay) {
...
function initHeroSliders() {
  ...
  sliders.forEach((slider) => {
    ...
    if (!section || !prevButton || !nextButton) return;
...
function initPartnersSliders() {
  const sliders = document.querySelectorAll('[data-fls-slider="partners"]');
  sliders.forEach((slider) => {
    const section = slider.closest("[data-fls-wdgpartners]");
    const prevButton = section?.querySelector(".slider-arrow_prev");
    const nextButton = section?.querySelector(".slider-arrow_next");
...
function initSpecialistsSliders() {
  const sliders = document.querySelectorAll('[data-fls-slider="specialists"]');
  sliders.forEach((slider) => {
    const section = slider.closest("[data-fls-wdgspecialists]");
    const prevButton = section?.querySelector(".slider-arrow_prev");
    const nextButton = section?.querySelector(".slider-arrow_next");
    if (!prevButton || !nextButton) return;
    new Swiper(slider, {
      ...
      a11y: {
        prevSlideMessage: "Previous specialists",
        nextSlideMessage: "Next specialists"
      },
      breakpoints: {
        575: {
          slidesPerView: 2.2,
...
function initGallerySliders() {
  const sliders = document.querySelectorAll('[data-fls-slider="gallery"]');
  sliders.forEach((slider) => {
    const section = slider.closest("[data-fls-wdggallery]");
    const prevButton = section?.querySelector(".slider-arrow_prev");
    const nextButton = section?.querySelector(".slider-arrow_next");
    if (!prevButton || !nextButton) return;
    new Swiper(slider, {
